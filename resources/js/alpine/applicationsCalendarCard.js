export function applicationsCalendarCardFactory() {
    return {
        ...
        updateJumpDate() {
            const day = this.selectedDate ? Number(this.selectedDate.split('-')[2]) : new Date().getDate();
            this.jumpDate = `${this.currentYear}-${String(this.currentMonth).padStart(2, '0')}-${String(day).padStart(2, '0')}`;
        },
