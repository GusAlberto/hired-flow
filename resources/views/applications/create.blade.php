    ...
    <div class="mx-auto max-w-5xl">
        ...
        <form method="POST" action="{{ route('applications.store') }}"
                        ...
                        <div class="mt-3 grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <input id="company" name="company" type="text" value="{{ old('company') }}" required
                                    class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200" />
            ...
            <div class="flex flex-wrap items-center justify-end gap-3 border-t border-slate-200 bg-slate-50 px-5 py-4">
                ...
                <button type="submit"
                    class="inline-flex items-center rounded-lg bg-blue-700 px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-800">
                    Save application
                </button>
            </div>
        </form>
