            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6">
                    <section class="rounded-xl border border-slate-200 bg-white p-5">
                        ...
                        <div class="space-y-3">
                            <div class="grid gap-2 {{ $canMovePrevious ? 'grid-cols-2' : 'grid-cols-1' }}">
                                @if ($canMovePrevious)
                                    <button type="button" wire:click="moveEditingApplicationToPreviousStage"
                                        class="inline-flex w-full items-center justify-center gap-1 rounded-full bg-slate-100 px-2.5 py-2 text-[11px] font-bold text-slate-700 transition hover:bg-slate-200">
                                        <svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                ...
                                <button type="button" wire:click="moveEditingApplicationToNextStage"
                                    class="inline-flex w-full items-center justify-center gap-1 rounded-full bg-blue-700 px-2.5 py-2 text-[11px] font-bold text-white transition hover:bg-blue-800">
